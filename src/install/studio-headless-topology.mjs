...
export function compileStudioRoster(input){
 ...
 return {schema:'xiio.sdk.studio-roster/v2',legacy_schema:'xiio.sdk.studio-roster/v1',registry_ref:input.registry_ref||null,registry_digest:input.registry_digest||null,registry_receipt_ref:input.registry_receipt_ref||null,registry_structural_complete:registryStructural,registry_verified:false,registry_complete:false,registry_proof_state:registryStructural?'SUPPLIED_UNVERIFIED':'UNKNOWN_BLOCKED',evidence_stack,evidence_structural_complete:evidenceStructural,evidence_verified:false,evidence_complete:false,evidence_proof_state:evidenceStructural?'SUPPLIED_UNVERIFIED':'UNKNOWN_BLOCKED',dependency_declarations_complete:missingDependencyDeclarations.length===0,dependency_closure:dependencyBlockers.length===0,products,product_count:products.length,server_count:products.length*3,verification_required:[...(registryStructural?['STUDIO_REGISTRY_PROVIDER_NATIVE_VERIFIER']:[]),...(evidenceStructural?['BINS_EVIDENCE_PROVIDER_NATIVE_VERIFIER']:[])],blockers,closure:false,hard:['REGISTRY_FLAG!=REGISTRY_PROOF','CALLER_ASSERTED_REGISTRY_PROOF!=TRUSTED_REGISTRY_PROOF','SUPPLIED_UNVERIFIED!=COMPLETE','MISSING_DEPENDENCY_DECLARATION!=NO_DEPENDENCIES','SCHEMA_V1_FALSE_GREEN_SEMANTICS!=V2_PROOF_CEILING','REGISTRY_COMPLETE_FALSE!=FULL_ROSTER','PRODUCT_OMISSION=BLOCKER','UNRESOLVED_DEPENDENCY=BLOCKER','PRODUCT_COUNT*3=MINIMUM_SERVER_COUNT','IMPACT_REPORT_WITHOUT_DATA_FORGE_DOTPROJECT_BUGZILLA=UNRELIABLE','PLACEHOLDER_ADAPTER!=IMPLEMENTATION']};
}
