...
const examples = {
  ...
  'confirmation-dialog': () => Core.renderActionButton({ label: 'Open dialog', dialogTarget: 'playground-dialog' }) + Core.renderConfirmationDialog({ id: 'playground-dialog', title: 'Confirm action', bodyHtml: '<p>Review this action before continuing.</p>' }),
