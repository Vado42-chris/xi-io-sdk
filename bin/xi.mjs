...
try {
  ...
  if (family === 'ibal' && action === 'project') {
    writeOutput(compileIbalRootProjection(readJson(flags.input, '--input')), flags.out);
  } else if (family === 'baseline' && action === 'compile') {
